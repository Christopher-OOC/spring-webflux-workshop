package com.javalord.weather_playground_test.sec05.controller;

import com.javalord.weather_playground_test.sec05.dto.CustomerDto;
import com.javalord.weather_playground_test.sec05.exception.ApplicationExceptions;
import com.javalord.weather_playground_test.sec05.filter.Category;
import com.javalord.weather_playground_test.sec05.service.CustomerService;
import com.javalord.weather_playground_test.sec05.validator.RequestValidator;
...
public class CustomerController {
    ...
    @GetMapping
    public Flux<CustomerDto> allCustomers(@RequestAttribute(name = "category") Category category) {
